...
/**
 * Rticketyeartab entity. @author MyEclipse Persistence Tools
 * Ʊ���������걨�� 
 */

public class Rticketyeartab  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private Long itickettypeid;//Ʊ���ͱ��
    ...
    /** default constructor */
    public Rticketyeartab() {
    }

	/** minimal constructor */
    public Rticketyeartab(Long id, String ryear) {
        this.id = id;
        this.ryear = ryear;
    }

	
	public Rticketyeartab(Long id, String times, Long itickettypeid,
			String sztickettypename, Long numb, String szmemo,
			String tickettype, Double mont, Double zfmont, Double yhmont,
			String ryear, Long isa, Long isb, Double dua, Double dub,
			String notea, String noteb, Long isc, Long isd, Long ise, Long isf,
