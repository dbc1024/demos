...
public class Rproviderfznumbmonthtab implements java.io.Serializable{
	private Long id;// ����	
	...
	public Rproviderfznumbmonthtab() {
	}

	public Rproviderfznumbmonthtab(Long id, String rdate, String rmonth,
			String ryear, String times, String bysalesvouchertype,
			Long iscenicid, Long ibusinessid, String isettlementid,
			Long iticketstationid, Long iemployeeid, Long itickettypeid,
			Long iticketnum, Long iticketplayer, Long ideratenums) {
		super();
		this.id = id;
		this.rdate = rdate;
		this.rmonth = rmonth;
	...
	public Rproviderfznumbmonthtab(Long id, String rdate, String rmonth,
			...
			Long iscenicid, Long ibusinessid, String isettlementid,
			Long iticketstationid, Long iemployeeid, Long itickettypeid,
			Long iticketnum, Long iticketplayer, Long ideratenums, Long isa,
			Long isb, Long isc, Long isd, Long ise, Long isf, Double dua,
			Double dub, Double duc, Double dud, Double due, Double duf,
			String notea, String noteb, String notec, String noted,
			String notee, String notef, String dtmakedate) {
		super();
		this.id = id;
		this.rdate = rdate;
		this.rmonth = rmonth;
