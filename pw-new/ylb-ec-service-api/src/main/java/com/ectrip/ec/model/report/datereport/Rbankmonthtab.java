...
/**
 * Rbankmonthtab entity. @author MyEclipse Persistence Tools
 * �����±��� 
 */

public class Rbankmonthtab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rbankmonthtab() {
    }

	/** minimal constructor */
    public Rbankmonthtab(Long id, String rmonth, String ryear, String times) {
        this.id = id;
        this.rmonth = rmonth;
        this.ryear = ryear;
        this.times = times;
    ...
    /** full constructor */
    public Rbankmonthtab(Long id, String rmonth, String ryear, String times, String bank, String bankname, Double zfmont, String szmemo, Long isa, Long isb, Double dua, Double dub, String notea, String noteb) {
        this.id = id;
        this.rmonth = rmonth;
        this.ryear = ryear;
        this.times = times;
