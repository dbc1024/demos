...
/**�����ͳ���걨��
 * Rwswarehouseyear entity. @author MyEclipse Persistence Tools
 */

public class Rwswarehouseyear implements java.io.Serializable {
	...
	/** default constructor */
	public Rwswarehouseyear() {
	}

	/** minimal constructor */
	public Rwswarehouseyear(Long statid) {
		this.statid = statid;
	}

	/** full constructor */
	public Rwswarehouseyear(Long statid, Long statdate,
