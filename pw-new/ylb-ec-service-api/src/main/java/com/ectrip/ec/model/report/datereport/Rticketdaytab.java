...
/**
 * Rticketdaytab entity. @author MyEclipse Persistence Tools
 * Ʊ���������ձ���
 */

public class Rticketdaytab  implements java.io.Serializable {


    // Fields    

     private Long id;//����
     private Long itickettypeid;//Ʊ����id
     ...
     private Long isa;//ҵ�����ͱ�� 
     private Long isb;//��Ⱥ������
     private Double dua;//����
     private Double dub;
     private String notea;//ҵ����������
    ...
    /** default constructor */
    public Rticketdaytab() {
    }

	/** minimal constructor */
    public Rticketdaytab(Long id, String times, String rdate, String rmonth, String ryear) {
        this.id = id;
        this.times = times;
        this.rdate = rdate;
        this.rmonth = rmonth;
	...
	public Rticketdaytab(Long id, Long itickettypeid, String sztickettypename,
			String times, Long numb, String szmemo, String tickettype,
			Double mont, Double zfmont, Double yhmont, String rdate,
			String rmonth, String ryear, Long isa, Long isb, Double dua,
			Double dub, String notea, String noteb, Long isc, Long isd,
			Long ise, Long isf, Double duc, Double dud, Double due, Double duf,
