...
/**
 * Rprovidermonthtab entity. @author MyEclipse Persistence Tools
 * �������±���
 */

public class Rprovidermonthtab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rprovidermonthtab() {
    }

	/** minimal constructor */
    public Rprovidermonthtab(Long id, String times, String rmonth, String ryear) {
        this.id = id;
        this.times = times;
        this.rmonth = rmonth;
        this.ryear = ryear;
    ...
    public Rprovidermonthtab(Long id, String times, Long iscenicid,
			String szscenicname, String szmemo, Double mont, Double zfmont,
			Double yhmont, Long numb, String rmonth, String ryear, Long isa,
