...
/**
 * Rcgroupsaledaytab entity. @author MyEclipse Persistence Tools
 * ǰ̨ע�������繺Ʊ�����ۣ������ձ�
 */

public class Rcgroupsaledaytab implements java.io.Serializable {
	...
	/** default constructor */
	public Rcgroupsaledaytab() {
	}

	/** minimal constructor */
	public Rcgroupsaledaytab(Long seq, String times,
	...
	public Rcgroupsaledaytab(Long seq, String times, String rdate,
			String rmonth, String ryear, String usid, String corpname,
			Long itickettypeid, String sztickettypename, Long numb,
			Double mont, Long isa, Long isb, Double dua, Double dub,
