...
public class HistZorderlist implements java.io.Serializable {

	// Fields

	private HistZorderlistId id;
	...
	private String orid;
	/** default constructor */
	public HistZorderlist() {
	}

	/** minimal constructor */
	public HistZorderlist(HistZorderlistId id, Long icrowdkindpriceid,
	...
	public HistZorderlistId getId() {
		return this.id;
	}

	public void setId(HistZorderlistId id) {
		this.id = id;
	}
