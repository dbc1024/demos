...
public class Rproviderfznumbdaytab implements java.io.Serializable{
	private Long id;// ����	
	...
	public Rproviderfznumbdaytab() {
	}

	public Rproviderfznumbdaytab(Long id, String rdate, String rmonth,
