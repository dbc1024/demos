 ...
 * @author huangyuqi
 */
public interface ICustomInfoDAO extends IGenericDao {
	 ...
	 * @return
	 */
	public PaginationSupport getCustomViewList(String lgtp,String ttlb,int pageSize, int startIndex,
			String path);
	/**
	 * 获取用户列表
	 * 
	 ...
	 * @return
	 */
	public PaginationSupport getCustomViewList(String lgtp,int pageSize, int startIndex,
			String path);
	/**
	 * 获取子用户列表
	 * Describe:
