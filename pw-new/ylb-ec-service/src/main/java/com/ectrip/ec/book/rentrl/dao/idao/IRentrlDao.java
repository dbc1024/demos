package com.ectrip.ec.book.rentrl.dao.idao;
...
public interface IRentrlDao extends IGenericDao{
	/**
	 * ���ݷ��������ͻ�÷����̿�Դ��
