...
import com.ectrip.sys.syspar.service.IReportsParService;

public class ReportsParService implements IReportsParService {
	private IReportsParDAO reportsparDao;
	
	
	public IReportsParDAO getReportsparDao() {
		return reportsparDao;
	}

	public void setReportsparDao(IReportsParDAO reportsparDao) {
		this.reportsparDao = reportsparDao;
	}
	...
	public PaginationSupport getTableParList(Tablepar tablepar,int page,int pageSize,String url){
		return reportsparDao.getTableParList(tablepar, page, pageSize, url);
	}
	...
	public PaginationSupport getColumnParList(Columnpar columnpar,int page,int pageSize,String url){
		return reportsparDao.getColumnParList(columnpar, page, pageSize, url);
	}
	...
	public void addTablePar(Tablepar tablepar,Syslog syslog){
		reportsparDao.addTablePar(tablepar, syslog);
	}
	/**
	 * 修改表字典
	 * Describe:
	...
	public void updateTablePar(Tablepar tablepar,Syslog syslog){
		reportsparDao.updateTablePar(tablepar, syslog);
	}
	...
	public void deleteTablePar(Long seq,Syslog syslog){
		reportsparDao.deleteTablePar(seq, syslog);
	}
	...
	public void addColumnPar(Columnpar columnpar,Syslog syslog){
		reportsparDao.addColumnPar(columnpar, syslog);
	}
	/**
	 * 修改列字典
	 * Describe:
	...
	public void updateColumnPar(Columnpar columnpar,Syslog syslog){
		reportsparDao.updateColumnPar(columnpar, syslog);
	}
	...
	public void deleteColumnPar(Columnpar columnpar,Syslog syslog){
		reportsparDao.deleteColumnPar(columnpar, syslog);
	}
	...
	public boolean queryTableIsUse(String tablename){
		return reportsparDao.queryTableIsUse(tablename);
	}
	/**
	 * 修改时判断列名是否已经唯一
	 * Describe:只能用作修改，增加时不可用
	...
	public boolean queryColumnIsUse(Long seq,String columnname){
		return reportsparDao.queryColumnIsUse(seq, columnname);
	}
