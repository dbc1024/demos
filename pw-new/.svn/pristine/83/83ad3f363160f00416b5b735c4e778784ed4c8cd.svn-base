...
/**
 * Rprovideryeartab entity. @author MyEclipse Persistence Tools
 * �������걨��
 */

public class Rprovideryeartab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rprovideryeartab() {
    }

	/** minimal constructor */
    public Rprovideryeartab(Long id, String times, String ryear) {
        this.id = id;
        this.times = times;
        this.ryear = ryear;
    }
    ...
    public Rprovideryeartab(Long id, String times, Long iscenicid,
			String szscenicname, String szmemo, Double mont, Double zfmont,
			Double yhmont, Long numb, String ryear, Long isa, Long isb,
