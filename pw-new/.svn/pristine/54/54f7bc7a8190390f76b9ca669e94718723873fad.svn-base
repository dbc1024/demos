 ...
 * 赋初始值：已完成！
 * <p>Java class for PayOrderResponseBody complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PayOrderResponseBody">
 *   &lt;complexContent>
...
@XmlType(name = "PayOrderResponseBody", propOrder = {
        "orderInfo"
})
public class PayOrderResponseBody
        extends ResponseBody
{

    @XmlElement(required = true)
    protected PayOrderResponseBody.OrderInfo orderInfo;

    public PayOrderResponseBody() {
        super();
        this.orderInfo = new PayOrderResponseBody.OrderInfo();
    }
     ...
     * @return
     *     possible object is
     *     {@link PayOrderResponseBody.OrderInfo }
     *
     */
    public PayOrderResponseBody.OrderInfo getOrderInfo() {
        return orderInfo;
    }
     ...
     *
     */
    public void setOrderInfo(PayOrderResponseBody.OrderInfo value) {
