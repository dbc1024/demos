...
/**
 * Rordemonthtab entity. @author MyEclipse Persistence Tools
 * �����±��� 
 */

public class Rordemonthtab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rordemonthtab() {
    }

	/** minimal constructor */
    public Rordemonthtab(Long id, String times, String rmonth, String ryear) {
        this.id = id;
        this.times = times;
        this.rmonth = rmonth;
        this.ryear = ryear;
    ...
    public Rordemonthtab(Long id, String orid, Double mont, Double zfmont,
			Double yhmont, String times, String szmemo, Long numb,
			String rmonth, String ryear, Long isa, Long isb, Long isc,
