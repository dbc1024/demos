...
/**
 * Iomstocksbill entity. @author MyEclipse Persistence Tools
 */

public class Iomstocksbill implements java.io.Serializable {
	...
	/** default constructor */
	public Iomstocksbill() {
	}

	/** minimal constructor */
	public Iomstocksbill(String szstocksbillid, String szstocksbillcode,
