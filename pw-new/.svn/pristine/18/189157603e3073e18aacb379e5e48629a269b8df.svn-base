...
/**
 * StssoldtickettabId entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Embeddable
public class StssoldtickettabId implements java.io.Serializable {
	...
	/** default constructor */
	public StssoldtickettabId() {
	}

	/** full constructor */
	public StssoldtickettabId(Long szsoldticketid, Long isalesvoucherdetailsid,
