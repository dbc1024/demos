...
/**
 * StscomticketsalesdetailstablsId entity. @author MyEclipse Persistence Tools
 */

public class StscomticketsalesdetailstablsId implements java.io.Serializable {
	...
	/** default constructor */
	public StscomticketsalesdetailstablsId() {
	}

	/** full constructor */
	public StscomticketsalesdetailstablsId(Long icomticketsalesdetailsid,
			Long isalesvoucherdetailsid, Long isalesvoucherid,
