...
/**
 * Rregionmonthtab entity. @author MyEclipse Persistence Tools
 * ��Դ���±���
 */

public class Rregionmonthtab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rregionmonthtab() {
    }

	/** minimal constructor */
    public Rregionmonthtab(Long id, String times, String rmonth, String ryear) {
        this.id = id;
        this.times = times;
        this.rmonth = rmonth;
        this.ryear = ryear;
    ...
    /** full constructor */
    public Rregionmonthtab(Long id, String times, Long iregionalid, String szregionalname, Long numb, String szmemo, Long iscenicid, String szscenicname, String rmonth, String ryear, Long isa, Long isb, Double dua, Double dub, String notea, String noteb) {
        this.id = id;
        this.times = times;
