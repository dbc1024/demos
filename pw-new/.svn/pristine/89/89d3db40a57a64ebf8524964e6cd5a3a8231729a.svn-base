...
/**
 * Rcustomyeartab entity. @author MyEclipse Persistence Tools
 */

public class Rcustomyeartab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rcustomyeartab() {
    }

	/** minimal constructor */
    public Rcustomyeartab(Long id, String times, String ryear) {
        this.id = id;
        this.times = times;
        this.ryear = ryear;
    }

	public Rcustomyeartab(Long id, String times, String usid, String szname,
			Long numb, String szmemo, String ryear, Long iscenicid,
			String szscenicname, Long isa, Long isb, Double dua, Double dub,
			String notea, String noteb) {
		super();
		this.id = id;
		this.times = times;
		this.usid = usid;
