...
/**
 * StssoldticketattesttabId entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Embeddable
public class StssoldticketattesttabId implements java.io.Serializable {
	...
	/** default constructor */
	public StssoldticketattesttabId() {
	}

	/** full constructor */
	public StssoldticketattesttabId(Long szsoldticketid,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StssoldticketattesttabId))
			return false;
		StssoldticketattesttabId castOther = (StssoldticketattesttabId) other;
