...
public class HistOrderId implements java.io.Serializable {
	...
	/** full constructor */
	public HistOrderId(String orid, Long iscenicid) {
		this.orid = orid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistOrderId))
			return false;
		HistOrderId castOther = (HistOrderId) other;
