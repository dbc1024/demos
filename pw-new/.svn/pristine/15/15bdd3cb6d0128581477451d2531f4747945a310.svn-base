...
/**�����ͳ���±���
 * Rwswarehousemonth entity. @author MyEclipse Persistence Tools
 */

public class Rwswarehousemonth implements java.io.Serializable {
	...
	/** default constructor */
	public Rwswarehousemonth() {
	}

	/** minimal constructor */
	public Rwswarehousemonth(Long statid) {
		this.statid = statid;
	}

	/** full constructor */
	public Rwswarehousemonth(Long statid, Long statdate,
