...
/**
 * Rcgroupsaleyeartab entity. @author MyEclipse Persistence Tools
 * ǰ̨ע�������繺Ʊ�����ۣ��������
 */

public class Rcgroupsaleyeartab implements java.io.Serializable {
	...
	/** default constructor */
	public Rcgroupsaleyeartab() {
	}

	/** minimal constructor */
	public Rcgroupsaleyeartab(Long seq, String times,
	...
	public Rcgroupsaleyeartab(Long seq, String times, String ryear,
			String usid, String corpname, Long itickettypeid,
