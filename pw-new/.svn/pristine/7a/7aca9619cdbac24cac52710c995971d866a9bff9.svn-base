...
@Embeddable
public class SoderollprintmanageId implements java.io.Serializable{
	...
	/** default constructor */
	public SoderollprintmanageId() {
	}

	/** full constructor */
	public SoderollprintmanageId(Long iscenicid, Long ibusinessid, String printno) {
