...
/**
 * Rcustomdaytab entity. @author MyEclipse Persistence Tools
 * �ο��ձ��� 
 */

public class Rcustomdaytab  implements java.io.Serializable {
    ...
    /** default constructor */
    public Rcustomdaytab() {
    }

	/** minimal constructor */
    public Rcustomdaytab(Long id, String times, String rdate, String rmonth, String ryear) {
        this.id = id;
        this.times = times;
        this.rdate = rdate;
        this.rmonth = rmonth;
    ...
    public Rcustomdaytab(Long id, String times, String usid, String szname,
			Long numb, String szmemo, String rdate, String rmonth,
			String ryear, Long iscenicid, String szscenicname, Long isa,
