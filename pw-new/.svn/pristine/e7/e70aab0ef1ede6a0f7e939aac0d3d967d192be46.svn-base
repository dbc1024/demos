...
/**
 * Stssoldtickettab entity. 售出门票表
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table
public class Stssoldtickettab implements java.io.Serializable {

	// stssoldtickettab

	@Id
	private StssoldtickettabId id;
	...
	@Transient
	private String szmemo;// 语音文件地址
	@Transient
	private String bymaketicketway;// 票的出票方式
	@Transient
	private List zlist;
	@Transient
	private List clist;
	...
	@Transient
	private String sztripid;// 竹筏趟次
	@Transient
	private String triptime;// 竹筏时间
	@Transient
	...
	public String getSztripid() {
		return sztripid;
	}

	public void setSztripid(String sztripid) {
		this.sztripid = sztripid;
	}
	...
	public void setZlist(List zlist) {
		this.zlist = zlist;
	}
	...
	/** minimal constructor */
	public Stssoldtickettab(StssoldtickettabId id, Long itickettypeid,
	...
	public Stssoldtickettab(StssoldtickettabId id, Long itickettypeid,
			...
			Double mpresentmoney, Double mactualsaleprice, Long ipresentnum,
			Long iremainnum, Double mnominalfee, Double mdeposit,
			String byticketpurpose, Double mrefundamount,
	...
	public StssoldtickettabId getId() {
		return this.id;
	}

	public void setId(StssoldtickettabId id) {
		this.id = id;
	}
