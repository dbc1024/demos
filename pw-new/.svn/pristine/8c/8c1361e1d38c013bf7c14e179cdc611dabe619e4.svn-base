...
public class CommonUtil {
    ...
    private static IGenericService genericService;
    ...
    public static String getprintmessage(Stssalesvouchertab s,Stssoldtickettab stsv,
        ...
        Stssalesvoucherdetailstab sd = (Stssalesvoucherdetailstab) genericDao
        ...
        Edmcrowdkindpricetab edmcrowdkindpricetab = (Edmcrowdkindpricetab) genericDao
                .get(Edmcrowdkindpricetab.class, sd.getIcrowdkindpriceid());
        Edpcrowdkindtab crowd = (Edpcrowdkindtab) genericDao.get(Edpcrowdkindtab.class, edmcrowdkindpricetab.getIcrowdkindid());

        List printlist = genericDao
                .find(" from Priceprintmanager where id.icrowdkindpriceid="
                        + sd.getIcrowdkindpriceid() + " order by ordernum");
        List syslist = genericDao.find(" from Sysparv5 where id.pmky='PRSZ'");
        ...
        if (printlist != null && printlist.size() > 0) {
            ...
            if (aprintlist != null && aprintlist.size() > 0) {
                for (int m = 0; m < aprintlist.size(); m++) {
                    Printticketmanage ap = (Printticketmanage) aprintlist.get(m);
        ...
        if (printlist != null && printlist.size() > 0) {
            ...
            for (int m = 0; m < printlist.size(); m++) {
                ...
                if (p.getId().getPrintno().equals("01")) {
                    ...
                    System.out.println("getprintmessage1");
                    dayin.append(";");
                }
                if (p.getId().getPrintno().equals("02")) {
                    ...
                    System.out.println("getprintmessage2");
                    dayin.append(";");
                }
                ...
                if (p.getId().getPrintno().equals("04")) {
                    ...
                    dayin.append(";");
                    System.out.println("getprintmessage4");
                }
                ...
                if (p.getId().getPrintno().equals("05")) {
                    ...
                    dayin.append(";");
                    System.out.println("getprintmessage5");
                }
                ...
                if (p.getId().getPrintno().equals("06")) {
                    ...
                    System.out.println("getprintmessage6");
                }
                ...
                if (p.getId().getPrintno().equals("07")) {
                    ...
                    for (int n = 0; n < zdetaillist.size(); n++) {
                        ...
                        Stscomticketsalesdetailstab zstd = (Stscomticketsalesdetailstab) zdetaillist
                                .get(n);
                        Trip t = (Trip) genericDao.get(Trip.class,
                                zstd.getTripid());
                        if (zstd.getTripid() > 0) {
                            if (p.getNoteprinttype().equals("1")) {
                                dayin.append(p.getSzprintno() + ":");
                ...
                if (p.getId().getPrintno().equals("08")) {
                    ...
                    if (!StringUtils.isBlank(s.getDyusid()) && !"null".equalsIgnoreCase(s.getDyusid())
                        ...
                        Custom c = (Custom) genericDao.get(Custom.class,
                                s.getDyusid());
                        if (p.getPrinttype().equals("0")) {
                            dayin.append(p.getNote());
                        } else {
                ...
                if (p.getId().getPrintno().equals("10")) {
                    ...
                    if (s.getIregionalid() != null
                        ...
                        Galsourceregiontab g = (Galsourceregiontab) genericDao
                ...
                if (p.getId().getPrintno().equals("12")) {
                    ...
                    if (p.getPrinttype().equals("0")) {
                        ...
                        Edpcrowdkindtab eb = (Edpcrowdkindtab) genericDao
                    ...
                    if (p.getPrinttype().equals("0")) {
                        ...
                        if (edticket.getBycategorytype().equals("0010")) {
                            ...
                            for (int n = 0; n < zdetaillist.size(); n++) {
                                Stscomticketsalesdetailstab zstd = (Stscomticketsalesdetailstab) zdetaillist
                                        .get(n);
                                Edmtickettypetab zticket = (Edmtickettypetab) genericDao
                ...
                if (p.getId().getPrintno().equals("17")) {
                    ...
                    for (int n = 0; n < zdetaillist.size(); n++) {
                        ...
                        if (zstd.getIvenueseatsid() > 0) {
                            Venueprogram vp = (Venueprogram) genericDao
                ...
                if (p.getId().getPrintno().equals("18")) {
                    ...
                    for (int n = 0; n < zdetaillist.size(); n++) {
                        ...
                        if (zstd.getIvenueareaid() > 0) {
                            Venuearea va = (Venuearea) genericDao.get(
                ...
                if (p.getId().getPrintno().equals("21")) {
                    // 售票员
                    Esfemployeetab esfemployeetab = (Esfemployeetab) genericDao
                            .get(Esfemployeetab.class, s.getIhandler());
                ...
                if (Integer.parseInt(p.getId().getPrintno()) > 24 && Integer.parseInt(p.getId().getPrintno())!=28 ) { //lizhaodong 添加了一个printno 28的控制
                    if (p.getPrinttype().equals("2")) {
                        ...
                        List list = null;
                        try {
                            list = genericDao.findBySqlToMap(sql);
        ...
        if (sprintlist != null && sprintlist.size() > 0) {
            ...
            for (int m = 0; m < sprintlist.size(); m++) {
                ...
                if (p.getId().getPrintno().equals("12")) {
                    ...
                    fujian.append(p.getSzprintno() + ":");
                    Edpcrowdkindtab eb = (Edpcrowdkindtab) genericDao.get(
    ...
    public static Custom xiazaiCustom(String usid,String url) {/*
        ...
        try {
            ...
            ResultBean cano = ssl.getCustom(usid);
            ...
            if (cano.getRowsCount() > 0) {// 中心服务器有数据
                ...
                for (int i = 0; i < cano.getRowsCount(); i++) {
                    ...
                    Custom cb = (Custom) genericService.get(Custom.class, ct.getUsid());
                    if (cb == null) {
    ...
    */
    ...
    public static double getUserMoney(String usid) {
        ...
        if(hqyt){
            ...
            Vipbalance vipbalance = (Vipbalance) genericService.get(Vipbalance.class, usid);
            if (vipbalance != null) {
    ...
    public static double getUserFrozenMoney(String usid) {
        ...
        if(!hqyt){
            ...
            List list = genericService.find(hsql);
            if (list != null && !list.isEmpty()) {
                Map map = (Map) list.get(0);
    ...
    public static float getUserMaxYfk(String usid) {
        ...
        String hql = " select new map( max(seq) as  cs ) From Useryfk   where usid =  '"
                + usid + "'";
        List<Map> list = genericService.find(hql);
    ...
    public static String getVerison(String type){
        String version = "";
        try{
            List<PMSVersion> pmsVersions =  genericService.find("from PMSVersion");
    ...
    public static boolean isHqyt(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0001"));
    ...
    public static String findPayUrl(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0002"));
        if(sys != null){
            return sys.getPmvb();
        }
        return "";
    ...
    public static String findScanCodeUrl(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0006"));
        if(sys != null){
            return sys.getPmvb();
        }
        return "";
    ...
    public static String findWdsKey(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0005"));
        if(sys != null){
            return sys.getPmvb();
        }
        return "";
    ...
    public static String findWxReturnUrl(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0003"));
        if(sys != null){
             return sys.getPmvc();
        }
        return "";
  ...
  public static String findSmfReturnUrl(String url2){
	...
	Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("APP","0001"));
	if(sys != null){
    ...
    public static String findQrUrl(){
        Sysparv5 sys = (Sysparv5) genericDao.get(Sysparv5.class,new Sysparv5Id("HQYT","0004"));
        if(sys != null){
            return sys.getPmvb();
        }
        return "";
    ...
    public static ProviderCompany findHqytId(String type,String usid,Long iscenicid){
        ...
        if(type.equalsIgnoreCase("01")) {
            Custom custom = (Custom) genericDao.get(Custom.class, usid);
            list = genericDao.find("from ProviderCompany where usid in ('" + usid + "','" + custom.getSusid() + "') and type = '01' ");
        }else{
            list = genericDao.find("from ProviderCompany where iscenicid = "+iscenicid+" and type = '02' ");
        }
        if(list != null && !list.isEmpty()){
            ProviderCompany pc = (ProviderCompany) list.get(0);
            return pc;
