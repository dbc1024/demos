...
public class DesUtil{
    ...
    public static final String ENCRYPT_KEY = "pay.jingqu.cn.encrypt.key";
    ...
    public static byte[] hexStr2ByteArr(String strIn) throws Exception{
        byte[] arrB = strIn.getBytes(CHARACTER);
        int iLen = arrB.length;
    ...
    public static byte[] encrypt(byte[] arrB, String setkey) throws Exception{
        ...
        Key key = getKey(setkey.getBytes(CHARACTER));
    ...
    public static String encrypt(String strIn, String setkey) throws Exception{
        return byteArr2HexStr(encrypt(strIn.getBytes(CHARACTER), setkey));
    }
