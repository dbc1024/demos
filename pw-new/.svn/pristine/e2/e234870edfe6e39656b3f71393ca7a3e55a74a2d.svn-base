...
/**
 * TZorderlistId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class HistZorderlistId implements java.io.Serializable {
	...
	/** default constructor */
	public HistZorderlistId() {
	}

	/** full constructor */
	public HistZorderlistId(Long zorderlistid, Long orderlistid, String orid,
			Long iscenicid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HistZorderlistId))
			return false;
		HistZorderlistId castOther = (HistZorderlistId) other;
