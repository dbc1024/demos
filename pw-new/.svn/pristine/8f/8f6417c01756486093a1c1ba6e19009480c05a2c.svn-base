...
import com.ectrip.sys.bank.dao.PullSeatDAO;
import com.ectrip.sys.bank.dao.idao.IPullSeatDAO;
import com.ectrip.sys.bank.service.iservice.IPullSeatService;

@Service
public class PullSeatService implements IPullSeatService {
	
	@Autowired
	private IPullSeatDAO pullSeatDao;
	...
	public List<Seatordertab> pullSeat(String orid) throws Exception {
		...
		List<TZorderlist> seatinfo = pullSeatDao.getOrderFilmInfo(orid);
		int trytime = 0;
