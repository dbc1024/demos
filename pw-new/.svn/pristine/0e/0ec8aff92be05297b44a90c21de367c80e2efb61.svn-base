...
/**
 * YZorderlist entity. @author MyEclipse Persistence Tools
 */

public class HisyZorderlist implements java.io.Serializable {

	// Fields

	private HisyZorderlistId id;
	...
	/** default constructor */
	public HisyZorderlist() {
	}

	/** minimal constructor */
	public HisyZorderlist(HisyZorderlistId id, Long icrowdkindpriceid, Long icrowdkindid,
	...
	public HisyZorderlistId getId() {
		return this.id;
	}

	public void setId(HisyZorderlistId id) {
		this.id = id;
	}
