...
@Embeddable
public class YOrderlistId implements java.io.Serializable {
	...
	/** full constructor */
	public YOrderlistId(Long orderlistid, String orid, Long iscenicid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof YOrderlistId))
			return false;
		YOrderlistId castOther = (YOrderlistId) other;
