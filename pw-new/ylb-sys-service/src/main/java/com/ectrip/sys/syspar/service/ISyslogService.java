...
public interface ISyslogService {
	...
	//  根据type 显示 前台 0后台 1订单操作日志
	
    public PaginationSupport getListOrderLogByType(String type,String usid,String orid,int pageSize,int startIndex,String url,String groupId);
	/**
	 * 
	 * Describe:添加后台操作日志
	 * @auth:lijingrui
