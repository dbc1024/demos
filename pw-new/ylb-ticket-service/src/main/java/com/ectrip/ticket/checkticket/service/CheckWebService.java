...
//        rs.setColumnNames(new String[] { "version"});
    ...
    public ResultBean CheckTicket(String ticketstr, String md5str,String newUrl,
        ...
        if (OtherString.length > 1) {
            if (OtherString[0].equals("0")) {
                return this.CheckTicket(ticketstr, md5str,newUrl,OtherString[1]);
            }
     ...
     */
    private ResultBean checkTicket(String ticketstr, String md5str1,String newUrl,String checkType)
            throws Exception {
        ...
        if (printno.length() == 18
            ...
            if (str.equals("1")) { // 导游
                ...
                rs.addRow(new String[]{"98"});// 无效票
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        rs.addRow(new String[]{"�����֤��ֹһ��Ʊ�����������֤��Ʊ"});
                return rs;
     ...
     * @author liujianwen
     */
    public ResultBean CheckTicket(String ticketstr, String md5str1,String newUrl,String checkType)
            throws Exception {
                		...
                		if (parrs[1].length() == 18) {
        					try {
        						...
        						if (list.size() != 0) {// 用游客身份证取出票号
        							...
        							if (stSubList.get(0).getIpasstimes() - stSubList.get(0).getIpassedtimes() == 0) {// �����Ʊ�Ѽ������Ӧ����Ϊ��Ʊ�˼�����Ʊ
...
//                    			printno = list.get(0).getSzticketprintno();
           ...
           /* if(strs1[1].toString()==null){
            ...
            return checkTicket(ticketstr, md5str1,newUrl,checkType);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public ResultBean LoclOffLineCheckTicket(String ticketstr, String md5str) {
        ...
        String[] params = ticketstr.split("[|]");
        String accid = params[0];// բ��ID
        String printno = params[1];// Ʊ��
