...
import com.ectrip.ticket.warehouse.service.iservice.IWarehouseTicketInService;

public class WarehouseTicketInService implements IWarehouseTicketInService {

	private IWarehouseTicketInDao iWarehouseTicketInDao;
	...
	public List showListticket(Long ihandler) {
		return iWarehouseTicketInDao.showListticket(ihandler);
	}
	...
	public List findAllPersonalticket(Long ihandler, Long itickettypeid){
		return iWarehouseTicketInDao.findAllPersonalticket(ihandler, itickettypeid);
	}
	...
	public boolean checkTicketcodeRange(long ticketid,String ticketCode, long idetailsid) {
		return iWarehouseTicketInDao.checkTicketcodeRange(ticketid,ticketCode, idetailsid);
	}
	...
	public long showiamount(long ticketid,String startcode, String endcode) {
		return iWarehouseTicketInDao.showiamount(ticketid,startcode, endcode);
	}
	...
	public List findPersonalticket(Long idetailsid){
		return iWarehouseTicketInDao.findPersonalticket(idetailsid);
	}
	...
	public boolean retrieWarehouse(Iompersonalticketdetails staDetails,long ihandler){
		return iWarehouseTicketInDao.retrieWarehouse(staDetails, ihandler);
	}
	 ...
	 * Date:2012-7-23
	 */
	public boolean insertstockbill(Iomstocksbill stocks, List<Iompersonalticketdetails> datailList,
								   Syslog syslog,Long bystockswayid) throws Exception {
		return iWarehouseTicketInDao.insertstockbill(stocks, datailList, syslog, bystockswayid);
	}



	public IWarehouseTicketInDao getiWarehouseTicketInDao() {
		return iWarehouseTicketInDao;
	}

	public void setiWarehouseTicketInDao(IWarehouseTicketInDao iWarehouseTicketInDao) {
		this.iWarehouseTicketInDao = iWarehouseTicketInDao;
	}
