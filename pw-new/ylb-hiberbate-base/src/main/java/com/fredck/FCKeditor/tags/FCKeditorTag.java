 ...
 * {@linkplain com.fredck.FCKeditor.FCKeditor container}.<br>
 * <p>
 * <b>Simple usage</b>:
 * 
 * <pre>
...
public class FCKeditorTag extends BodyTagSupport {
	 ...
	 * "http://www.fredck.com/images/Logo.gif", without touching the "src"
	...
	/**
	 * Sets the path to the skin (graphical interface settings) to be used by
	 * the editor.
	 * 
	 * @param value
	 *            path
	...
	/**
	 * Tells the editor to automatically detect the user language preferences to
	 * adapt its interface language.<br>
	 ...
	 * The default language is used when the AutoDetectLanguage options is
	 * disabled or when the user language is not available.
	 * 
	 * @param value
	 *            language code
	 */
	...
	/**
	 * Tells the editor to process the HTML source to XHTML when switching from
	 * WYSIWYG to Source view
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	...
	/**
	 * Block elements (like P, DIV, H1, PRE, etc...) are forced to have content
	 * (a &amp;nbsp;).<br>
	 * Empty blocks are "collapsed" by while browsing, so a empty
	 * &lt;p&gt;&lt;/p&gt; is not visible.<br>
	 * While editing, the editor "expand" empty blocks so you can insert content
	 * inside then.<br>
	 * Setting this option to "true" results useful to reflect the same output
	 * when browsing and editing.
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	...
	/**
	 * The HTML shown by the editor, while switching from WYSIWYG to Source
	 * views, will be processed and formatted
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	...
	/**
	 * Tells Gecko browsers to use SPAN instead of &lt;B&gt;, &lt;I&gt; and
	 * &lt;U&gt; for bold, italic an underline
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	 ...
	 * "&amp;amp;"<BR>
	 * This conversion is a W3C requirement for XHTML, so it is recommended to
	 * leave this option to "false".
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	...
	/**
	 * Set the number of spaces (&amp;nbsp;) to be inserted when the user hits
	 * the "tab" key.<BR>
	...
	/**
	 * Inserts a &lt;BR&gt; tag when the user hits the "enter" key, instead of
	 * starting a new paragraph (&lt;P&gt; or &lt;DIV&gt;).<BR>
	 * This is an Internet Explorer only feature. Other browsers insert the
	 * &lt;BR&gt; tag by default.
	 * 
	 * @param value
	 *            true/false
	...
	/**
	 * The toolbar is Expanded on startup, otherwise it is Collapsed and the
	 * user must click on it to show it.
	 * 
	 * @param value
	 *            true/false
	 * @throws JspException
	...
	/**
	 * Tells the editor that the toolbar can be Collapsed/Expanded by the user
	 * when clicking the vertical bar placed on the left of it (on the right for
	 * "rtl" languages).
	 * 
	 * @param value
	 *            true/false
	 ...
	 * styles used by the "Style" toolbar command
	 * 
	 * @param value
	 *            path
	 */
	...
	/**
	 * Sets the URL of the page called when the user clicks the "Browse Server"
	 * button in the "Link" dialog window.<BR>
	 * In this way, you can create your custom File Browser that is well
	...
	/**
	 * Sets the URL of the page called when the user clicks the "Browse Server"
	 * button in the "Image" dialog window.<BR>
	 * In this way, you can create your custom Image Browser that is well
	 * integrated with your system.
	 * 
	 * @param value
	 *            path
	...
	/**
	 * Sets the URL of the page called when the user clicks the "Browse Server"
	 * button in the "Flash" dialog window.<BR>
	 * In this way, you can create your custom Flash Browser that is well
	 * integrated with your system.
	 * 
	 * @param value
	 *            path
	...
	/**
	 * Sets the URL of the upload handler called when the user clicks the "Send
	 * it to server" button in the "Link" dialog window.<BR>
	 * In this way, you can create your custom Link Uploader that is well
	 * integrated with your system.
	 * 
	 * @param value
	 *            path
	...
	/**
	 * Sets the URL of the upload handler called when the user clicks the "Send
	 * it to server" button in the "Image" dialog window.<BR>
	 * In this way, you can create your custom Image Uploader that is well
	 * integrated with your system.
	 * 
	 * @param value
	 *            path
	...
	/**
	 * Sets the URL of the upload handler called when the user clicks the "Send
	 * it to server" button in the "Flash" dialog window.<BR>
	 * In this way, you can create your custom Flash Uploader that is well
	 * integrated with your system.
	 * 
	 * @param value
	 *            path
