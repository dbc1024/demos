...
import com.sims.loginSystem1.util.HttpUtil;
...
public class LoginController {
	...
	public String login(String username, String password, HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		return "redirect:http://www.sso.com:8080/login/checkLogin?domain=www.pw.com:8081&username="+ username +"&password="+ password;
	}
	...
	public String receiveToken(HttpServletRequest request){
		...
		if("true".equals(success)){
			...
			return "redirect:http://www.pw.com:8081/home";
		}
		
		return "redirect:http://www.pw.com:8081/login.html";
	}
	...
	public String logout(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		return "redirect:http://www.sso.com:8080/login/logout?domain=www.pw.com:8081";
	}
